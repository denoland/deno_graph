...
impl TestBuilder {
  ...
  #[allow(unused)]
  pub fn unstable_extended_json_imports(&mut self, value: bool) -> &mut Self {
    self.unstable_extended_json_imports = value;
    self
  }
    ...
    graph
      .build(
        ...
        deno_graph::BuildOptions {
          ...
          unstable_extended_json_imports: self.unstable_extended_json_imports,
