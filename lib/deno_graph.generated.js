...
// source-hash: 874cfd2975cdea4f6403a99f724108982ebefd4e
let wasm;
...
export class Module {
   ...
   */
  get source_map() {
    const ret = wasm.module_source_map(this.ptr);
    return takeObject(ret);
  }
  /**
   * @returns {string | undefined}
  ...
  get source_map_url() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.module_source_map_url(retptr, this.ptr);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      let v0;
      if (r0 !== 0) {
...
const imports = {
  __wbindgen_placeholder__: {
    ...
    __wbindgen_closure_wrapper1871: function (arg0, arg1, arg2) {
