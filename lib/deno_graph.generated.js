...
import * as import0 from "./snippets/deno_graph-0b8972da967ef709/src/deno_apis.js";
...
function __wbg_adapter_22(arg0, arg1, arg2) {
  wasm
    ._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb260ffb1428fd8dc(
      arg0,
      arg1,
      addHeapObject(arg2),
    );
...
function __wbg_adapter_79(arg0, arg1, arg2, arg3) {
  wasm.wasm_bindgen__convert__closures__invoke2_mut__h495572bf41b16b2a(
    arg0,
    arg1,
    addHeapObject(arg2),
    addHeapObject(arg3),
...
export class Module {
  ...
  /**
   * @returns {ParsedSource | undefined}
   */
  get parsedSource() {
    var ret = wasm.module_parsedSource(this.ptr);
    return ret === 0 ? undefined : ParsedSource.__wrap(ret);
  }
  /**
   * @returns {string}
   */
...
const ParsedSourceFinalization = new FinalizationRegistry((ptr) =>
  wasm.__wbg_parsedsource_free(ptr)
);
/** */
export class ParsedSource {
  static __wrap(ptr) {
    const obj = Object.create(ParsedSource.prototype);
    obj.ptr = ptr;
    ParsedSourceFinalization.register(obj, obj.ptr, obj);
    return obj;
  }
  ...
  __destroy_into_raw() {
    const ptr = this.ptr;
    this.ptr = 0;
    ParsedSourceFinalization.unregister(this);
    return ptr;
  }
  ...
  /**
   * @returns {TranspiledSource}
   */
  transpile() {
    var ret = wasm.parsedsource_transpile(this.ptr);
    return TranspiledSource.__wrap(ret);
  }
}

const TranspiledSourceFinalization = new FinalizationRegistry((ptr) =>
  wasm.__wbg_transpiledsource_free(ptr)
);
/** */
export class TranspiledSource {
  static __wrap(ptr) {
    const obj = Object.create(TranspiledSource.prototype);
    obj.ptr = ptr;
    TranspiledSourceFinalization.register(obj, obj.ptr, obj);
    return obj;
  }
  ...
  __destroy_into_raw() {
    const ptr = this.ptr;
    this.ptr = 0;
    TranspiledSourceFinalization.unregister(this);
    return ptr;
  }
  ...
  get text() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.transpiledsource_text(retptr, this.ptr);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      return getStringFromWasm0(r0, r1);
    } finally {
  ...
  get sourceMap() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.transpiledsource_sourceMap(retptr, this.ptr);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      let v0;
      if (r0 !== 0) {
...
const imports = {
  __wbindgen_placeholder__: {
    ...
    __wbindgen_closure_wrapper1541: function (arg0, arg1, arg2) {
      var ret = makeMutClosure(arg0, arg1, 267, __wbg_adapter_22);
      return addHeapObject(ret);
    },
  },
  "./snippets/deno_graph-0b8972da967ef709/src/deno_apis.js": import0,
};
